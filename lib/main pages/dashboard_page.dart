    ...
    child: Row(
                          ...
                          Row(
                            children: [
                              CircleAvatar(
                                ...
                                backgroundColor: Colors.blue.shade50,
                                child: Icon(
                                  isCredit ? Icons.arrow_downward : Icons.phone_android,
                            ...
                            Text.rich(
                              TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(text: "for every transaction"),
                                ],
                              ),
                            ),
                          ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.card_giftcard_outlined), label: "Reward"),
